...
public class AlbumAdapterMultiColumn extends RecyclerView.Adapter<AlbumAdapterMultiColumn.Holder>{

    private GeneralItemClick clickInterface;
    private List<AlbumMediaItem> items = new ArrayList<>();
    private Context context;

    public AlbumAdapterMultiColumn(GeneralItemClick clickInterface) {
        this.clickInterface = clickInterface;
    }

    public AlbumAdapterMultiColumn() {
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AlbumAdapterMultiColumn.Holder(binding.getRoot(),binding);
    }
