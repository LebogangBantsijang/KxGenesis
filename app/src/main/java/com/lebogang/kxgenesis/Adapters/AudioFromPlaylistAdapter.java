...
public class AudioFromPlaylistAdapter extends RecyclerView.Adapter<AudioFromPlaylistAdapter.Holder>{
    ...
    public AudioFromPlaylistAdapter(GeneralItemClick clickInterface) {
        this.clickInterface = clickInterface;
    }

    public AudioFromPlaylistAdapter() {
    }
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AudioFromPlaylistAdapter.Holder(binding.getRoot(),binding);
    }
    ...
    protected void highlight(AudioFromPlaylistAdapter.Holder holder, AudioMediaItem audioItem, Context context){
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(@NonNull View itemView, ItemSongBinding binding) {
            ...
            binding.imageButton.setImageResource(R.drawable.ic_multiply_24dp);
