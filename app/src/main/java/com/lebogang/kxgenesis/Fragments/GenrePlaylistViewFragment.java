...
import com.lebogang.kxgenesis.databinding.FragmentGenrePlaylistViewBinding;

import java.util.List;
import java.util.concurrent.TimeUnit;

public class GenrePlaylistViewFragment extends Fragment implements GeneralItemClick, AudioCallBacks {
    private FragmentGenrePlaylistViewBinding binding;
    private AudioAdapter adapter = new AudioAdapter(this);
    private MediaItem mediaItem;
    private AudioViewModel viewModel;

    public GenrePlaylistViewFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentGenrePlaylistViewBinding.inflate(inflater, container, false);
