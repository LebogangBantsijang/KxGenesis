...
import com.lebogang.kxgenesis.databinding.FragmentMediaSettingsBinding;
...
public class MediaSettingsFragment extends Fragment {
    ...
    private void initRepeatSwitch(){
        ...
        binding.repeatCheckBox.setChecked(value);
        binding.repeatCheckBox.setOnCheckedChangeListener((buttonView, isChecked) -> AppSettings.setRepeatModeSaved(requireContext(), isChecked));
    }

    private void initFilterViews(){
        binding.filterSeekBar.setProgress(AppSettings.getFilterDuration(requireContext(), true));
        binding.filterSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                if (fromUser){
                    AppSettings.setFilter(requireContext(), progress);
                }
            }
