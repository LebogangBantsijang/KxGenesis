...
public class PlayerControlsFour extends AbstractPlayer{
    ...
    private final ImageView albumArtImageView, volLowImageView, volHighImageView;
    private final View overlayView,controlsContainer;

    public PlayerControlsFour(AppCompatActivity activity, View view) {
        ...
        volLowImageView = view.findViewById(R.id.volLowImageView);
        volHighImageView = view.findViewById(R.id.volHighImageView);
        super.initViews();
    }
    ...
    public void onMediaChanged(Audio audio) {
        ...
        controlsContainer.setBackgroundColor(AudioIndicator.Colors.getBackgroundColor());
        titleTextView.setTextColor(AudioIndicator.Colors.getTextColor());
        subtitleTextView.setTextColor(AudioIndicator.Colors.getTextColor());
        endDurationTextView.setTextColor(AudioIndicator.Colors.getTextColor());
        startDurationTextView.setTextColor(AudioIndicator.Colors.getTextColor());
        playButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        nextButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        prevButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        shareButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        repeatButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        shuffleButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        collapseButton.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        seekBar.setThumbTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        seekBar.setProgressTintList(ColorStateList.valueOf(AudioIndicator.Colors.getDrawableTintColor()));
        volSeekBar.setThumbTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        volSeekBar.setProgressTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        volHighImageView.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
        volLowImageView.setImageTintList(ColorStateList.valueOf(AudioIndicator.Colors.getTextColor()));
